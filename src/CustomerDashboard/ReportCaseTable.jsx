...
const ReportCaseTable = () => {
            ...
            servicesData.forEach((service) => {
              if (service.reportFormJson && service.reportFormJson.json) {
                ...
                if (heading) {
                  let status = service.annexureData?.status || "Initiated";
                  status =
                    (status || "").replace(/[^a-zA-Z0-9\s]/g, " ").toUpperCase() ||
                    "Initiated";
  ...
  return (
    <div className="">
      <h2 className="py-4 text-2xl font-bold text-center text-[#3e76a5] ">
        Report & Case Status
      </h2>
            ...
            <form action="">
              <div className="flex gap-2">
                ...
                <select
                  ...
                  className="outline-none border-2 p-2 border-gray-300 shadow-md rounded-md w-full md:w-5/12 my-4 md:my-0"
                >
                ...
                }} className='outline-none pe-14 ps-2 border-gray-300 shadow-md text-left p-3 md:w-6/12 w-7/12 rounded-md border'>
                ...
                <button
                  ...
                  className="bg-[#3e76a5] text-white whitespace-nowrap text-sm py-3 px-4 rounded-md capitalize"
                  type="button"
          ...
          <div className="col md:flex justify-end ">
            <form action="">
              <div className="flex md:items-stretch items-center gap-3">
                <input
                  type="search"
                  className="outline-none border-2 p-3 text-sm border-gray-300 shadow-md rounded-md w-full my-4 md:my-0"
          ...
          {loading ? (
            ...
            <table className="min-w-full border-collapse border overflow-scroll rounded-lg whitespace-nowrap">
              ...
              <tbody>
                {loading ? (
                  <tr>
                    <td colSpan={17} className="py-4 text-center text-gray-700">
