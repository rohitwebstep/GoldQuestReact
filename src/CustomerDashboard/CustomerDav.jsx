...
const CandidiateDav = () => {
    ...
    const isApplicationExists = useCallback(() => {
        ...
        fetch(`https://api.goldquestglobal.in/branch/candidate-application/dav-application-by-id?${queryString}`)
            .then(res => res.json())
            .then(result => {
            ...
            .catch(err => {
                ...
                setIsBranchApiLoading(false);  // Stop global loading spinner in case of error.
            ...
            .finally(() => {
                setIsBranchApiLoading(false); // Ensure global loading state is reset
            });
    }, []);
