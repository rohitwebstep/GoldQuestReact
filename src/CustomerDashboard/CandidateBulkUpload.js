...
const CandidateBulkUpload = () => {
    ...
    return (
        ...
        <div className="bg-[#c1dff2]" ref={candidateEditRef} id="candidateedit" >
            <h2 className="text-2xl font-bold py-3 text-left text-[#4d606b] px-3 border">CANDIDATE BULK UPLOAD </h2>
