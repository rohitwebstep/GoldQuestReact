    ...
    <>
      <div className=" py-4 px-4 bg-white m-3" >
        ...
        <form className="grid md:grid-cols-4 grid-cols-1 gap-3 p-3 border mb-4 rounded-md">
          <div className="mb-4">
            <label className="text-sm font-bold text-gray-700" htmlFor="reportGeneratedby">REPORT GENERATED BY</label>
            <select
              name="reportgenerateby" // Updated name
              id="reportGeneratedby"
              className="outline-none pe-14 ps-2 border-gray-300 shadow-md text-left rounded-md w-full border p-2 mt-2"
          ...
          <div className="mb-4">
            <label className="text-sm block font-bold text-gray-700" htmlFor="date">
              DATE
            </label>
          ...
          <div className="mb-4">
            <label className="text-sm font-bold text-gray-700" htmlFor="ReportGeneratedMonth">REPORT GENERATED BY MONTH</label>
            <select
              name="month"
              id="ReportGeneratedMonth"
              className="outline-none pe-2 border-gray-300 shadow-md  ps-2 text-left rounded-md w-full border p-2 mt-2"
              onChange={handleChange}
              value={filters.month}
            >
          ...
          <div className="mb-4">
            <label className="text-sm block font-bold text-gray-700" htmlFor="QCStatus" >
              QC STATUS FETCH
            </label>
            <select
              name="qc_status"
