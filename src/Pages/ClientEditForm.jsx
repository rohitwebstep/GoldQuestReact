    ...
    return (
        <>
            <div className="py-4 md:py-16 m-4">
                <h2 className="md:text-2xl text-2xl text-[#3e76a5] md:mb-8 font-bold pb-8 md:pb-4 text-center">
                    Client Edit
                </h2>
                        ...
                        (<form onSubmit={handleClientSubmit} >
                            <div className="md:flex gap-5">
                                <div className="mb-4 md:w-6/12">
                                    <label className="font-bold text-gray-700" htmlFor="name">Company Name: <span className="text-red-600">*</span></label>
                                    <input
                                        type="text"
                                        name="name"
                                        id="name"
                                ...
                                <div className="mb-4 md:w-6/12">
                                    <label className="font-bold text-gray-700" htmlFor="client_unique_id">Client Code: <span className="text-red-600">*</span></label>
                                    <input
                                        type="text"
                            ...
                            <div className="md:flex gap-5">
                                <div className="mb-4 md:w-6/12">
                                    <label className="font-bold text-gray-700" htmlFor="address">address: <span className="text-red-600">*</span></label>
                                    <input
                                        type="text"
                                        name="address"
                                        id="address"
                                ...
                                <div className="mb-4 md:w-6/12">
                                    <label className="font-bold text-gray-700" htmlFor="mobile">Mobile: <span className="text-red-600">*</span></label>
                                    <input
                                        type="number"
                                        name="mobile"
                                        id="mobile"
                            ...
                            <div className="md:flex gap-5">
                                ...
                                <div className="mb-4 md:w-6/12">
                                    <label className="font-bold text-gray-700" htmlFor="contact_person_name">Contact Person: <span className="text-red-600">*</span></label>
                                    <input
                                        type="text"
                                ...
                                <div className="mb-4 md:w-6/12">
                                    <label className="font-bold text-gray-700" htmlFor="state">State: <span className="text-red-600">*</span></label>
                                    <select name="state" id="state" className="w-full border-gray-300 shadow-md  border p-2 rounded-md mt-2" ref={(el) => (refs.current["state"] = el)}
                            ...
                            <div className="md:flex gap-5">
                                <div className="mb-4 md:w-6/12">
                                    <label className="font-bold text-gray-700" htmlFor="state_code">State Code: <span className="text-red-600">*</span></label>
                                    <input
                                        type="text"
                                        name="state_code"
                                        id="state_code"
                                ...
                                <div className="mb-4 md:w-6/12">
                                    <label className="font-bold text-gray-700" htmlFor="escalation_admin_id">Name of the Escalation Point of Contact:<span className="text-red-600">*</span></label>
                                ...
                                <div className="mb-4">
                                    <label className="font-bold text-gray-700" htmlFor="director_email">Director email
                                    </label>
                                    <input
                                        type="text"
                                        name="director_email"
                            ...
                            <div className="mb-4">
                                <label className="font-bold text-gray-700" htmlFor="emails">Emails:</label>
                                        ...
                                        newEmails.map((email, index) => (
                                            <div key={index} className="flex gap-2 mt-3 md:mt-0">
                                                <input
                                                    type="email"
                                                    value={email}
                                                    className="border rounded-md p-2 border-gray-300 shadow-md  outline-none w-full"
                            ...
                            <div className="md:flex gap-5">
                                <div className="mb-4 md:w-6/12">
                                    <label className="font-bold text-gray-700" htmlFor="single_point_of_contact">Name of The Client SPOC:<span className="text-red-600">*</span></label>
                                    <input
                                        type="text"
                                ...
                                <div className="mb-4 md:w-6/12">
                                    <label className="font-bold text-gray-700" htmlFor="gst_number">GSTIN <span className="text-red-600">*</span></label>
                                    <input
                                        type="text"
                                        name="gst_number"
                                        id="gst_number"
                            ...
                            <div className="md:flex gap-5">
                                <div className="mb-4 md:w-6/12">
                                    <label className="font-bold text-gray-700" htmlFor="tat_days">TAT: <span className="text-red-600">*</span></label>
                                    <input
                                        type="number"
                                        name="tat_days"
                                        id="tat_days"
                                ...
                                <div className="mb-4 md:w-6/12">
                                    <label className="font-bold text-gray-700" htmlFor="agreement_date">Date of Service Agreement:<span className="text-red-600">*</span></label>
                                    {/* <input
                                        type="date"
                                        name="agreement_date"
                                        id="agreement_date"
                                    ...
                                    /> */}
                                    <DatePicker
                                        selected={clientData.agreement_date}
                                        onChange={(date) => handleDateChange(date, 'agreement_date')}
                            ...
                            <div className="md:flex gap-5">
                                <div className="mb-4 md:w-6/12">
                                    <label className="font-bold text-gray-700" htmlFor="client_standard">Client Standard Procedure:</label>
                                ...
                                <div className="mb-4 md:w-6/12">
                                    <label className="font-bold text-gray-700" htmlFor="agreement_duration">Agreement Period</label>

                                    <select name="agreement_duration"
                                        className="border w-full border-gray-300 shadow-md  rounded-md p-2 mt-2 outline-none" id="agreement_duration" onChange={handleClientChange} value={clientData.agreement_duration}>
                            ...
                            <div className="mb-4">
                                <label className="font-bold text-gray-700" htmlFor="agr_upload">Agreement Upload:<span className="text-red-500">*</span></label>
                            ...
                            <div className="mb-4">
                                <label className="font-bold text-gray-700" htmlFor="industry_classification">Industry Classification<span className="text-red-600">*</span></label>
                                <input
                                    type="text"
                            ...
                            <div className="mb-4">
                                <label className="font-bold text-gray-700" htmlFor="custom_template">Required Custom Template:<span className="text-red-600">*</span></label>
                                <select
                                ...
                                {clientData.custom_template === 'yes' && (
                                    <>
                                        <div className="mb-4 mt-3">
                                            <label htmlFor="custom_logo" className="text-gray-700">Upload Custom Logo :<span className="text-red-600">*</span></label>
                                            <input
                                        ...
                                        <div className="mb-4">
                                            <label htmlFor="custom_address" className="text-gray-700">Custom Address</label>
                                            <textarea
                                                name="custom_address"
                                                id="custom_address"
                                                onChange={handleClientChange}
                            ...
                            <div className="mb-4">
                                <label className="font-bold text-gray-700" htmlFor="additional_login">Additional login Required</label>
                            ...
                            <div className="mb-4 flex gap-2 justify-start items-center">
                                ...
                                />
                                <label className="font-bold text-gray-700" htmlFor="is_custom_bgv">Custom BGV</label>
                            </div>
